...
Infomaniak Authenticator for Android includes the following third-party libraries in the distributed application (runtime dependencies; test-only dependencies are excluded):
