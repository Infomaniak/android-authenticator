    ...
    get() {
        ...
        _dataProtectionLight = Builder(
            ...
            path(
                ...
                stroke = SolidColor(Color(0xFF3243AE)),
                strokeLineWidth = 0.5f,
                strokeLineCap = Round,
                strokeLineJoin = Miter,
                strokeLineMiter = 4.0f,
            ...
            path(
                ...
                moveTo(63.01f, 13.13f)
                lineTo(63.08f, 13.21f)
                lineTo(72.72f, 23.65f)
                lineTo(72.8f, 23.73f)
                lineTo(72.79f, 23.84f)
                lineTo(70.91f, 48.47f)
                lineTo(70.89f, 48.7f)
                horizontalLineTo(18.23f)
                lineTo(18.22f, 48.47f)
                lineTo(15.54f, 13.4f)
                lineTo(15.52f, 13.13f)
                horizontalLineTo(63.01f)
                close()
            }
            path(
                ...
                moveTo(63.36f, 13.62f)
                lineTo(72.18f, 23.33f)
                lineTo(72.56f, 23.75f)
                horizontalLineTo(61.2f)
                lineTo(61.25f, 23.46f)
                lineTo(62.93f, 13.74f)
                lineTo(63.02f, 13.24f)
                lineTo(63.36f, 13.62f)
                close()
            }
            path(
