...
public val AppIllus.ShieldPersonLight: ImageVector
    get() {
        if (_shieldPerson != null) {
            return _shieldPerson!!
        }
        _shieldPerson = Builder(
            name = "ShieldPerson",
            ...
            path(
                ...
                lineTo(227.42f, 100.45f)
                lineTo(226.98f, 101.35f)
                close()
                moveTo(151.0f, 237.58f)
                lineTo(150.63f, 238.51f)
                lineTo(151.0f, 238.65f)
                lineTo(151.37f, 238.51f)
                lineTo(151.0f, 237.58f)
                close()
                moveTo(75.02f, 101.35f)
                lineTo(74.58f, 100.45f)
                lineTo(74.02f, 100.73f)
                lineTo(74.02f, 101.35f)
                horizontalLineTo(75.02f)
                close()
                moveTo(151.0f, 64.42f)
                lineTo(151.44f, 63.52f)
                lineTo(151.0f, 63.31f)
                lineTo(150.56f, 63.52f)
                lineTo(151.0f, 64.42f)
                close()
                moveTo(226.98f, 101.35f)
                horizontalLineTo(225.98f)
                curveTo(225.98f, 123.14f, 220.87f, 151.6f, 208.86f, 177.31f)
                curveTo(196.86f, 203.02f, 178.02f, 225.88f, 150.63f, 236.65f)
                lineTo(151.0f, 237.58f)
                lineTo(151.37f, 238.51f)
                curveTo(179.38f, 227.49f, 198.53f, 204.15f, 210.67f, 178.15f)
                curveTo(222.81f, 152.16f, 227.98f, 123.4f, 227.98f, 101.35f)
                horizontalLineTo(226.98f)
                close()
                moveTo(151.0f, 237.58f)
                lineTo(151.37f, 236.65f)
                curveTo(123.98f, 225.88f, 105.14f, 203.02f, 93.14f, 177.31f)
                curveTo(81.13f, 151.6f, 76.02f, 123.14f, 76.02f, 101.35f)
                horizontalLineTo(75.02f)
                horizontalLineTo(74.02f)
                curveTo(74.02f, 123.4f, 79.19f, 152.16f, 91.33f, 178.15f)
                curveTo(103.46f, 204.15f, 122.62f, 227.49f, 150.63f, 238.51f)
                lineTo(151.0f, 237.58f)
                close()
                moveTo(75.02f, 101.35f)
                lineTo(75.45f, 102.25f)
                lineTo(151.44f, 65.32f)
                lineTo(151.0f, 64.42f)
                lineTo(150.56f, 63.52f)
                lineTo(74.58f, 100.45f)
                ...
                close()
                moveTo(151.0f, 64.42f)
                lineTo(150.56f, 65.32f)
                lineTo(226.55f, 102.25f)
                lineTo(226.98f, 101.35f)
                lineTo(227.42f, 100.45f)
                lineTo(151.44f, 63.52f)
                lineTo(151.0f, 64.42f)
            ...
            path(
                ...
                lineTo(226.98f, 101.35f)
                curveTo(226.98f, 145.19f, 206.4f, 215.78f, 151.0f, 237.58f)
                close()
            }
            path(
                fill = SolidColor(Color(0xFFffffff)),
            ...
            path(
                ...
                moveTo(136.41f, 135.89f)
                horizontalLineToRelative(29.99f)
                verticalLineToRelative(29.99f)
                horizontalLineToRelative(-29.99f)
                close()
            }
            path(
                ...
                curveTo(143.99f, 154.07f, 146.35f, 152.86f, 148.88f, 152.37f)
                curveTo(147.6f, 151.97f, 146.41f, 151.26f, 145.44f, 150.29f)
                curveTo(143.86f, 148.71f, 142.97f, 146.57f, 142.97f, 144.33f)
                curveTo(142.97f, 142.09f, 143.86f, 139.95f, 145.44f, 138.36f)
                close()
...
private fun Preview() {
    Box {
        Image(
            imageVector = AppIllus.ShieldPersonLight,
