...
val AppIllus.BannerNotificationDark: ImageVector
    get() {
        if (_bannerNotificationDark != null) {
            return _bannerNotificationDark!!
        }
        _bannerNotificationDark = Builder(
            name = "BannerNotificationDark",
...
private var _bannerNotificationDark: ImageVector? = null
...
private fun Preview() {
    Box {
        Image(
            imageVector = AppIllus.BannerNotificationDark,
