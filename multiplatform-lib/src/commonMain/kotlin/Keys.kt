...
class LegacySecret internal constructor()
...
/**
 * Something derived from a [PrivateKey] that can be checked for authenticity with the matching [PublicKey].
 */
class KeyDerivative internal constructor()
